...
export default function BitcoinPrice() {
    ...
    return (
        <div className='h-screen flex flex-col px-96 items-center justify-center'>
            {isLoading && (
            ...
            {!isLoading && bitcoin === null && (
                <div className="text-red-500">Error fetching Bitcoin data.</div>
            )}
        </div>
    )
}